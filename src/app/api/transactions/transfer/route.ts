...
export async function POST(request: Request) {
  try {
    ...
    await prisma.$executeRaw`
      ...
      VALUES (${idOrigem}, ${'Saída: ' + cleanDesc}, ${Number(amount)}, ${txDate}, 'EXPENSE'::"TransactionType", ${categoryId}, ${fromAccountId}, ${transferId}, ${payee || null}, ${payer || null}, ${bankRefId || null}, ${externalId ? externalId + '_out' : null}, ${now}, ${now})
    `;
    ...
    await prisma.$executeRaw`
      INSERT INTO "Transaction" (id, description, amount, date, type, "categoryId", "accountId", "transferId", payee, payer, "bankRefId", "externalId", "createdAt", "updatedAt")
      VALUES (${idDestino}, ${'Entrada: ' + cleanDesc}, ${Number(amount)}, ${txDate}, 'INCOME'::"TransactionType", ${categoryId}, ${toAccountId}, ${transferId}, ${payee || null}, ${payer || null}, ${bankRefId || null}, ${externalId ? externalId + '_in' : null}, ${now}, ${now})
    `;
