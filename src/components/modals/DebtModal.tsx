...
export default function DebtModal({ isOpen, onClose, onSuccess, debt }: DebtModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-md rounded-[2rem] p-8 shadow-2xl transform animate-in zoom-in-95">
        <h2 className="text-2xl font-black text-gray-900 mb-6">{debt ? 'Editar Dívida' : 'Nova Dívida'}</h2>
